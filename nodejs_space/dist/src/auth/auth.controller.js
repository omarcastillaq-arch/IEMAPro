...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Registrar nuevo usuario (paciente)' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Registro exitoso' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Correo ya registrado' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Usuario actual' }),
